odoo.define('action_client_example_module', function(require){
    'use strict';
    ...
    var action_client_example = AbstractAction.extend({
    ...
    core.action_registry.add('action_client_example', action_client_example)
    return action_client_example
